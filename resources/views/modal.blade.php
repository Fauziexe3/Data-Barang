    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-body">
                    <form action="/index/update/{{ $item->kd_brg }}" method="POST" enctype="multipart/form-data">
                        @method ('post')
                        @csrf
                        <div class="mb-3">
                            <label for="exampleInputEmail1">Kode Barang</label>
                            <input type="text" name="kd_brg" class="form-control" id="exampleInputEmail1 "
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jumlah_brg" class="form-control" id="exampleInputEmail1"
